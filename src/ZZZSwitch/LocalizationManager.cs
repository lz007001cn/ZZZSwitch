...
public sealed class LocalizationManager
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Chinese =
        new Dictionary<string, string>
        {
            ...
            ["L.Server.GlobalDescription"] = "切换并恢复国际服缓存",
            ["L.Server.CnDescription"] = "切换并恢复国服缓存",
            ["L.Server.BilibiliDescription"] = "国服资源与B站登录窗",
            ...
            ["L.Summary.Packages"] = "差异包",
            ["L.Summary.Cache"] = "双服热更新缓存",
            ["L.Summary.CacheManagement"] = "缓存管理",
            ["L.Summary.InitializeCache"] = "初始化当前服缓存",
            ["L.Settings.Title"] = "设置",
    ...
    private static readonly IReadOnlyDictionary<string, string> English =
        new Dictionary<string, string>
        {
            ...
            ["L.Server.GlobalDescription"] = "Switch and restore the Global cache",
            ["L.Server.CnDescription"] = "Switch and restore the CN cache",
            ["L.Server.BilibiliDescription"] = "CN resources with Bilibili login",
            ...
            ["L.Summary.Packages"] = "Packages",
            ["L.Summary.Cache"] = "Hot-update caches",
            ["L.Summary.CacheManagement"] = "Cache management",
            ["L.Summary.InitializeCache"] = "Initialize current cache",
