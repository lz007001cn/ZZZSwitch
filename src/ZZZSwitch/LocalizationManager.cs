...
public sealed class LocalizationManager
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Chinese =
        new Dictionary<string, string>
        {
            ...
            ["L.Main.Check"] = "检查",
            ["L.Check.Title"] = "检查与修复",
            ["L.Check.Hint"] = "按需检查和修复。重置仅清除识别状态；未完成操作请使用重试恢复。",
            ["L.Check.Detect"] = "重新检测",
            ["L.Check.Repair"] = "修复资源",
            ["L.Check.Packages"] = "修复差异包…",
            ["L.Check.Reset"] = "重置识别状态",
            ["L.Check.Recover"] = "重试恢复",
            ["L.Check.Logs"] = "打开日志",
            ...
            ["L.Settings.CheckApplicationUpdate"] = "软件更新 / 检查更新",
            ["L.Settings.Logs"] = "日志",
    ...
    private static readonly IReadOnlyDictionary<string, string> English =
        new Dictionary<string, string>
        {
            ...
            ["L.Main.Tools"] = "Tools",
            ["L.Main.Backups"] = "Backups",
            ["L.Main.Check"] = "Check",
            ["L.Check.Title"] = "Check and repair",
            ["L.Check.Hint"] = "Run checks and repairs when needed. Reset clears detection only; use retry recovery for unfinished operations.",
            ["L.Check.Detect"] = "Re-detect",
            ["L.Check.Repair"] = "Repair resources",
            ["L.Check.Packages"] = "Repair packages…",
            ["L.Check.Reset"] = "Reset detection",
            ["L.Check.Recover"] = "Retry recovery",
            ["L.Check.Logs"] = "Open logs",
            ...
            ["L.Summary.Cache"] = "Resource cache",
            ...
            ["L.Settings.CheckApplicationUpdate"] = "Application updates / Check for updates",
