...
It can automatically detect the game installation directory and provides **differential package deployment, region cache initialization**, and fast switching between the **CN / Global / Bilibili**.
